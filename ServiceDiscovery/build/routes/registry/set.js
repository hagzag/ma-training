...
var insertRegistry = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, key, value;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, redis_api_1.hsetAsync)(constants_1.default.RegistryKeyName, [key, value])];
            case 1:
                _b.sent();
                res.status(201).end();
                return [2 /*return*/];
