...
var insertMultiRegistry = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var parsedBody;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, redis_api_1.hsetAsync)(constants_1.default.RegistryKeyName, parsedBody)];
            case 1:
                _a.sent();
                res.status(201).end();
                return [2 /*return*/];
...
var parseRequestBody = function (body) {
    ...
    for (var i = 0; i < body.length; i++) {
        var _a = body[i], key = _a.key, value = _a.value;
        if (!key || !value) {
            return;
        }
