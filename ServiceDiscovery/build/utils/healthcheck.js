...
var redis_api_1 = require("./redis-api");
                ...
                services.forEach(function (serviceName) { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 2:
                                _a.sent();
                                if (!(deletedIps === serviceIPs.length)) return [3 /*break*/, 4];
...
setInterval(healthCheck, 1000 * 60 * constants_1.default.healthCheckIntervalInMinutes);
